...
<div class="header">
        ...
        <div class="flex items-center">
          <nav class="text-left hidden md:block">
            ...
            @auth
                    ...
                    <a href="{{ url('account') }}" class="router-link-active router-link-exact-active flex items-center text-md px-4 py-2 shadow-md hover:shadow-2xl border rounded-full text-black bg-pink-500 text-white font-primary" aria-current="page">
                        ...
                        <span class="ml-1">{{ str_replace('.00', '', auth()->user()->balance) }}৳</span>
                    </a>
                    <div class="flex items-center cursor-pointer px-2 duration-75 w-16 profile">
                        <img src="https://ui-avatars.com/api/?name={{ strtoupper(substr(auth()->user()->name, 0, 1)) }}&size=96&background=f29f2c" class="rounded-full">
                    </div>
 ...
 <footer data-v-4c1ace0e="" class="mb-16 md:mb-0 text-gray-200 border-t-2 footer-bg">
        ...
        {{ $settings->site_name }}{{ __('. All Rights Reserved.') }} {{ __('Developed by') }}
<a href="https://XYLSOFT.t.me"
   target="_blank" rel="noopener noreferrer" style="color: #FFFF00; font-weight: bold;">
     XYL SOFT
</a>
                </div>
              </div>
